...
display_banner() {
    ...
    echo -e "                Author: ${GREEN}Alim${NC} (${GREEN}Alimvpn${NC})"
    echo -e "                © 2024 Recoded by Alim"
}
...
"'&reply_markup={"inline_keyboard":[[{"text":"izin","url":"https://t.me/Sekizo666"},{"text":"grup","url":"https://t.me/Lionkingvpn"}]]}'
